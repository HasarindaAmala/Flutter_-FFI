...
// late ReceivePort _workerResponsePort;
...
//     _workerIsolate = await Isolate.spawn(frameProcessorIsolate, _workerResponsePort.sendPort);
//     _workerSendPort = await _workerResponsePort.first as SendPort;
//   }
//
//   Future<void> _stopWorkerIsolate() async {
...
//     if (_boxOrigin == null || _previewSize == null || _workerSendPort == null) return;
...
//
//     _workerSendPort!.send(FrameParams(
//       y: Uint8List.fromList(img.planes[0].bytes),
//       u: Uint8List.fromList(img.planes[1].bytes),
//       v: Uint8List.fromList(img.planes[2].bytes),
//       width: img.width,
//       height: img.height,
//       yStride: img.planes[0].bytesPerRow,
//       uvStride: img.planes[1].bytesPerRow,
//       uvPixelStride: img.planes[1].bytesPerPixel!,
//       roi: roi,
//       replyPort: responsePort.sendPort,
//     ));
//
//     final stats = await responsePort.first as List<double>;
//
//     if (!mounted) {
//       _processing = false;
//       return;
...
//     _processing = false;
//   }
// //previous working on frame function is commented out here-->
//
...
// }
//
// void frameProcessorIsolate(SendPort mainSendPort) {
//   final port = ReceivePort();
//   mainSendPort.send(port.sendPort);
//
//   port.listen((message) {
//     if (message is FrameParams) {
//       final stats = processFrameColor(
//         yPlane: message.y,
//         uPlane: message.u,
//         vPlane: message.v,
...
//         yRowStride: message.yStride,
//         uvRowStride: message.uvStride,
//         uvPixelStride: message.uvPixelStride,
//         roi: message.roi,
//       );
//       message.replyPort.send(stats);
//     }
//   });
// }
//
